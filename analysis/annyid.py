...
indexer = read_pickle(data_path/"indexer.pkl")
...
for l in top21_list:
    top20_list += l
annoyied_top21 = {indexer['i'][k]:[indexer['i'][x] for x in v]for k, v in dict(zip(id_list, top20_list)).items()}       
with open(cache_path/"annoyid2top20sim_dict_.pkl", "wb") as f:
